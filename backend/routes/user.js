...
router.route("/my/posts").get(isAuthenticated, getMyPosts);    //written after at a time of frontend

router.route("/userposts/:id").get(isAuthenticated, getUserPosts);       //written after time 4:57:00
